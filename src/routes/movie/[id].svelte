<script context="module"> 
   ...
   export async function load({fetch, params}) {
        ...
        const movieDetail = await res.json(); //A lekérdezés eredményét jsonbe rakjuk
        if (res.ok) {
            return {
                props: {movieDetail} //Publikusan elérhetővé tesszük a lekérdezett adatokat
            }
        }
   } 
</script>
...
<div class="movie-details" in:fly= {{y: 50, duration: 500, delay: 500}} out:fly= {{y: 50, duration: 500}}>
